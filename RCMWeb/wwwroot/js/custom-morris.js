(function ($) {
  ...
  var lineMorris = new Morris.Line({
    ...
    resize: true,
    data: [
      { y: '2021 Q1', Appointments: 20 },
      { y: '2021 Q2', Appointments: 15 },
      { y: '2021 Q3', Appointments: 34 },
      { y: '2021 Q4', Appointments: 7 },
      { y: '2022 Q1', Appointments: 31 },
      { y: '2022 Q2', Appointments: 18 },
      { y: '2022 Q3', Appointments: 70 },
      { y: '2022 Q4', Appointments: 32 },
        {   y: 'Q1', Appointments: 15 },
      { y: '2022 Q2', Appointments: 53 }
    ],
    xkey: 'y',
    ykeys: ['Appointments'],
    labels: ['Appointments'],
